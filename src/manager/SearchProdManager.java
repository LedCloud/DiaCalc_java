    ...
    public Collection doSearch(String string4search){
        ...
        try{
            ...
            if (string4search.length()>0){
                FirstCapital = (""+string4search.charAt(0)).toUpperCase() + 
                    string4search.substring(1);
            }*/
            ...
            String toadd ="";
            String stringClean = string4search.replace("'", "").replace("*", "").replace(";", "");
            if (stringClean.length()>0){
                toadd = SearchString.getSQLPart(stringClean,SearchString.PRODUCTS,null);
                if (!toadd.isEmpty()){
