...
public class CoefTableModel  extends AbstractTableModel {
    ...
    private User user;
    private final CoefsManager mgr;
    ...
    public CoefTableModel(User user){
        ...
        coefs = new ArrayList(mgr.getCoefs());
    }
    ...
    public void setValueAt(Object value, int row, int col){
        if (col>0){
          ...
          coefs = new ArrayList(mgr.updateCoef(cf));
    ...
    public void addRow(CoefsSet cf){
          coefs = new ArrayList(mgr.addCoef(cf));
    ...
    public void deleteRow(int row){
        ...
        if (sz>0){
          CoefsSet cf = (CoefsSet)coefs.get(row);
          coefs = new ArrayList(mgr.deleteCoef(cf));
